...
Keep your computer always active. This program taps 'Right Shift' key in periodic intervals set by user, which is a relatively harmless key in terms of interruptions to user's PC usage.
